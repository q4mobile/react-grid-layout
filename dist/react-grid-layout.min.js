!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      function p(t, e, n) {
        for (
          var r = w(t), o = O(t, e), a = Array(t.length), i = 0, s = o.length;
          i < s;
          i++
        ) {
          var u = c(o[i]);
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (k["[object Float32Array]"] = k["[object Float64Array]"] = k[
          ...
          (k[u] = k[l] = k[z] = k[f] = k[j] = k[p] = k[h] = k[d] = k[g] = k[
            m
          ] = k[b] = k[x] = k[S] = k[O] = k["[object WeakMap]"] = !1);
              ...
              : (function(t, e, n, r, o, s) {
                  ...
                  if (!(n & a)) {
                    var C = w && K.call(t, "__wrapped__"),
                      k = R && K.call(e, "__wrapped__");
                    if (C || k) {
                      var E = C ? t.value() : t,
                        T = k ? e.value() : e;
                      return s || (s = new jt()), o(E, T, n, r, s);
                    }
                  }
                  if (!D) return !1;
                  return (
                    ...
                    (function(t, e, n, r, o, i) {
                      ...
                      for (var f = l; f--; ) {
                        var p = u[f];
                        if (!(s ? p in e : K.call(e, p))) return !1;
                      }
                      var h = i.get(t);
        ...
        function Pt(t) {
          return (
            !(!$t(t) || ((e = t), Q && Q in e)) && (Gt(t) ? tt : D).test(Yt(t))
          );
          var e;
        }
        function Mt(t) {
        ...
        ((ct && It(new ct(new ArrayBuffer(1))) != j) ||
          (ft && It(new ft()) != g) ||
...
*/
	...
	*/
        ...
        var C = (function() {
            ...
            if (t in e) return "";
            for (var n = 0; n < j.length; n++) if (D(t, j[n]) in e) return j[n];
            return "";
          })(),
          k = function(t, e) {
            if (!(t instanceof e))
        ...
        function Y(t) {
          ...
          return (e += R(n.borderTopWidth)), (e += R(n.borderBottomWidth));
        }
        function q(t) {
          var e = t.clientWidth,
            n = t.ownerDocument.defaultView.getComputedStyle(t);
          return (e += R(n.borderLeftWidth)), (e += R(n.borderRightWidth));
        }
        function X(t) {
          var e = t.clientHeight,
            n = t.ownerDocument.defaultView.getComputedStyle(t);
          return (e -= R(n.paddingTop)), (e -= R(n.paddingBottom));
        }
        function F(t) {
          var e = t.clientWidth,
            n = t.ownerDocument.defaultView.getComputedStyle(t);
          return (e -= R(n.paddingLeft)), (e -= R(n.paddingRight));
        }
        function U(t, e, n) {
          var r = t.x,
            o = t.y,
                ...
                if (e.props.bounds) {
                  ...
                  var s = (function(t, e, n) {
                      ...
                      if ("string" == typeof r) {
                        ...
                        r = {
                          left:
                            -o.offsetLeft + R(l.paddingLeft) + R(u.marginLeft),
                          top: -o.offsetTop + R(l.paddingTop) + R(u.marginTop),
                          right:
                            F(s) -
                            q(o) -
                            o.offsetLeft +
                      ...
                      return (
                        _(r.right) && (e = Math.min(e, r.right)),
                        _(r.bottom) && (n = Math.min(n, r.bottom)),
                        _(r.left) && (e = Math.max(e, r.left)),
          ...
          (e.prototype.onDragHandler = function(t) {
            ...
            return function(n, r) {
              var o = r.node,
                ...
                s = e.props[t];
              if (s) {
                var u = { top: 0, left: 0, scaleX: 1, scaleY: 1 };
                switch (t) {
                  case "onDragStart":
                    var l = o.offsetParent;
                    if (!l) return;
                    for (var c = l, f = 1, p = 1; c; ) {
                      var h = getComputedStyle(c).transform.match(
                        /\d+(?:\.\d+)?/g
                      );
                      if (null !== h && h.length >= 4) {
                        var d = parseFloat(h[0]),
                          y = parseFloat(h[3]);
                        isNaN(d) || isNaN(y) || ((f *= d), (p *= y));
                      }
                      c = c.offsetParent;
                    }
                    var g = l.getBoundingClientRect(),
                      m = o.getBoundingClientRect();
                    (u.left = (m.left - g.left + l.scrollLeft) / f),
                      (u.top = (m.top - g.top + l.scrollTop) / p),
                      (u.scaleX = f),
                      (u.scaleY = p),
                  ...
                  case "onDrag":
                    ...
                    (u.left =
                      e.state.dragging.left + a / e.state.dragging.scaleX),
                      (u.top =
                        e.state.dragging.top + i / e.state.dragging.scaleY),
                      (u.scaleX = e.state.dragging.scaleX),
                      (u.scaleY = e.state.dragging.scaleY),
                      e.setState({ dragging: u });
                    break;
                  case "onDragStop":
                    if (!e.state.dragging)
                ...
                var v = e.calcXY(u.top, u.left),
                  b = v.x,
                  w = v.y;
                return s.call(e, e.props.i, b, w, {
                  e: n,
                  node: o,
                  newPosition: u
                });
